...
- Call save_memory only after the user explicitly approves the exact durable fact being saved. A direct request to Claude to remember, add, update, or correct that same fact is the approval to mirror it to Mora; never ask the user to approve it again.
...
const handler = createMcpHandler(
  ...
  {
    serverInfo: { name: "mora", version: "0.2.3" },
