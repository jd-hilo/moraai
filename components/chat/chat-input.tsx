    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow: "0 14px 36px rgba(43,34,27,0.06)",
          maxWidth: "860px",
          margin: "0 auto",
          display: "flex",
        ...
        >
                        ...
                        {group.map((m) => (
                          <button
                            ...
                            style={{
                              ...
                              fontSize: 13,
                              fontFamily: "var(--font-ui)",
                              color: m.id === selectedModelId ? "var(--color-text-primary)" : "var(--color-text-secondary)",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "50%",
              border: "none",
              background: hasText && !disabled ? "var(--gradient-peach)" : "rgba(22,21,20,0.09)",
              color: hasText && !disabled ? "var(--color-text-primary)" : "var(--color-text-muted)",
