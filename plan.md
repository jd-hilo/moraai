...
- Expose only `get_mora_status`, `recall_twin`, `save_memory`, `list_simulations`, and `get_simulation` through MCP. Existing simulation creation and execution remain available in Mora's web app.
